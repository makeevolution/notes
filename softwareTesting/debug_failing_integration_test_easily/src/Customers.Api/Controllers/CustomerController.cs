...
public class CustomerController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] CustomerRequest request)
    {
        ...
        throw new Exception("SImulating Failure. With the XUnitLoggerProvider in EasierToDebug, you will see this exception in that test's output, making it easier to debug.");
